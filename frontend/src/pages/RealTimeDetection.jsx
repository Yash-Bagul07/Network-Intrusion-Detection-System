    ...
    <div className="grid grid-cols-12 gap-6 animate-fade-in">
      ...
      <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
        <div className="bg-dark-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/5 shadow-2xl flex-1 overflow-hidden flex flex-col">
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2 text-orange-400"><Activity className="w-5 h-5"/> Live Threat Feed</h2>
              ...
              alerts.map((alert, i) => (
                ...
                `}>
                  <div className="flex justify-between items-start mb-2">
                     <span className="font-mono text-xs text-gray-400">{new Date(alert.timestamp).toLocaleTimeString()}</span>
